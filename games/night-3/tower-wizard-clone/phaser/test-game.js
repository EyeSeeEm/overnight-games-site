...
async function testGame() {
    ...
    console.log('=== TOWER WIZARD CLONE PHASER TEST ===\n');

    await page.goto('file:///workspace/games/night-3/tower-wizard-clone/phaser/index.html');
    ...
    // Click summon spirit button
    const summonX = 1024 - 310 + 150;
    const summonY = 272;
